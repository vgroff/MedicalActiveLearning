...
# Converted nested lists to np arrays
def listsToArray(lists):
    return np.array(lists)

# Convert numpy array tp nested lists
...
# NOT USED ANYMORE (GEODESIC MIN USED INSTEAD)
def updateGeodesics(maxPathLength, stdDev, minEdge, minEdge2, img, probs, segmentation, weighting):
 ...
 # Build the array of weights for loss func  
