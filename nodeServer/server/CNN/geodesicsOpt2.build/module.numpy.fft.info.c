...
{
    const_str_digest_84a497729464c78aa5c26800f7c822ac = UNSTREAM_STRING( &constant_bin[ 590186 ], 17, 0 );
    const_str_digest_859b42178da8db0a15c4de3463d88383 = UNSTREAM_STRING( &constant_bin[ 590203 ], 14, 0 );
    const_str_digest_9b5c5c95185362a2fccae62102a5e845 = UNSTREAM_STRING( &constant_bin[ 590217 ], 23, 0 );
    const_str_digest_441f88f623c6b812d8a5ef52c952ed3d = UNSTREAM_STRING( &constant_bin[ 590240 ], 7098, 0 );
...
static PyCodeObject *codeobj_988604a3d34ad5b2ef60557f35f924d3;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_84a497729464c78aa5c26800f7c822ac );
    codeobj_988604a3d34ad5b2ef60557f35f924d3 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_9b5c5c95185362a2fccae62102a5e845, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_988604a3d34ad5b2ef60557f35f924d3;
    ...
    // Frame without reuse.
    frame_988604a3d34ad5b2ef60557f35f924d3 = MAKE_MODULE_FRAME( codeobj_988604a3d34ad5b2ef60557f35f924d3, module_numpy$fft$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_988604a3d34ad5b2ef60557f35f924d3 );
    assert( Py_REFCNT( frame_988604a3d34ad5b2ef60557f35f924d3 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_988604a3d34ad5b2ef60557f35f924d3 );
#endif
    popFrameStack();

    assertFrameObject( frame_988604a3d34ad5b2ef60557f35f924d3 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_988604a3d34ad5b2ef60557f35f924d3, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_988604a3d34ad5b2ef60557f35f924d3->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_988604a3d34ad5b2ef60557f35f924d3, exception_lineno );
    }
