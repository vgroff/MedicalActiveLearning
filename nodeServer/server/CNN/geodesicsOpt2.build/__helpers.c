...
{
    { "geodesicsOpt2", MOD_INIT_NAME( geodesicsOpt2 ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "numpy._import_tools", MOD_INIT_NAME( numpy$_import_tools ), 0, 0, NUITKA_COMPILED_MODULE },
    { "numpy.add_newdocs", MOD_INIT_NAME( numpy$add_newdocs ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "numpy.distutils", NULL, 1578705, 1115, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.distutils.__config__", NULL, 1579820, 1518, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.__version__", NULL, 1581338, 365, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.ccompiler", NULL, 1581703, 21577, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.compat", NULL, 1603280, 503, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.exec_command", NULL, 1603783, 8517, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.info", NULL, 1612300, 351, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.log", NULL, 1612651, 2706, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.misc_util", NULL, 1615357, 72110, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.npy_pkg_config", NULL, 1687467, 13440, NUITKA_BYTECODE_FLAG },
    { "numpy.distutils.unixccompiler", NULL, 1700907, 3668, NUITKA_BYTECODE_FLAG },
    ...
    { "numpy.random.info", MOD_INIT_NAME( numpy$random$info ), 0, 0, NUITKA_COMPILED_MODULE },
    { "numpy.testing", NULL, 1704575, 728, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing.decorators", NULL, 1705303, 290, NUITKA_BYTECODE_FLAG },
    { "numpy.testing.nose_tools", NULL, 1705593, 156, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "numpy.testing.nose_tools.decorators", NULL, 1705749, 9195, NUITKA_BYTECODE_FLAG },
    { "numpy.testing.nose_tools.nosetester", NULL, 1714944, 16160, NUITKA_BYTECODE_FLAG },
    { "numpy.testing.nose_tools.utils", NULL, 1731104, 66973, NUITKA_BYTECODE_FLAG },
    { "numpy.testing.nosetester", NULL, 1798077, 427, NUITKA_BYTECODE_FLAG },
    { "numpy.testing.utils", NULL, 1798504, 1047, NUITKA_BYTECODE_FLAG },
