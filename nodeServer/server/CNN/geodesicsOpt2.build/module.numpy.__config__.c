...
static void createModuleConstants( void )
{
    ...
    const_str_digest_4eab28f3252a78fa9161d21baa3024f3 = UNSTREAM_STRING( &constant_bin[ 4534 ], 11, 0 );
    const_str_plain_HAVE_CBLAS = UNSTREAM_STRING( &constant_bin[ 4545 ], 10, 1 );
    const_str_plain_blas_mkl_info = UNSTREAM_STRING( &constant_bin[ 4555 ], 13, 1 );
    ...
    const_str_digest_24cccd96eb56be45d452be79ede867b1 = UNSTREAM_STRING( &constant_bin[ 4568 ], 5, 0 );
    const_str_plain_extra_dll_dir = UNSTREAM_STRING( &constant_bin[ 4573 ], 13, 1 );
    const_str_plain_openblas_lapack_info = UNSTREAM_STRING( &constant_bin[ 4586 ], 20, 1 );
    const_str_plain_openblas = UNSTREAM_STRING( &constant_bin[ 4586 ], 8, 1 );
    const_dict_4cfc716647ba196cb1bf4d8db725eb5f = _PyDict_NewPresized( 4 );
    const_str_plain_define_macros = UNSTREAM_STRING( &constant_bin[ 4606 ], 13, 1 );
    ...
    const_str_plain_language = UNSTREAM_STRING( &constant_bin[ 4619 ], 8, 1 );
    PyDict_SetItem( const_dict_4cfc716647ba196cb1bf4d8db725eb5f, const_str_plain_language, const_str_plain_c );
    const_str_plain_library_dirs = UNSTREAM_STRING( &constant_bin[ 4627 ], 12, 1 );
    const_list_str_digest_4773e7fe4aa07e55d10b222a9fe8df91_list = PyList_New( 1 );
    const_str_digest_4773e7fe4aa07e55d10b222a9fe8df91 = UNSTREAM_STRING( &constant_bin[ 4639 ], 14, 0 );
    ...
    const_str_plain_libraries = UNSTREAM_STRING( &constant_bin[ 4653 ], 9, 1 );
    ...
    const_str_plain_lapack_opt_info = UNSTREAM_STRING( &constant_bin[ 4662 ], 15, 1 );
    const_int_neg_60 = PyLong_FromLong( -60l );
    const_str_plain_blis_info = UNSTREAM_STRING( &constant_bin[ 4677 ], 9, 1 );
    const_str_plain_get_info = UNSTREAM_STRING( &constant_bin[ 4686 ], 8, 1 );
    const_str_plain_openblas_info = UNSTREAM_STRING( &constant_bin[ 4694 ], 13, 1 );
    const_str_plain_sources = UNSTREAM_STRING( &constant_bin[ 4707 ], 7, 1 );
    ...
    const_str_plain_lapack_mkl_info = UNSTREAM_STRING( &constant_bin[ 4714 ], 15, 1 );
    const_str_plain_pathsep = UNSTREAM_STRING( &constant_bin[ 4729 ], 7, 1 );
    const_str_digest_e8ea4fff12303266a6d98f0124dfb5f1 = UNSTREAM_STRING( &constant_bin[ 4736 ], 15, 0 );
    const_str_digest_52db4daa349fd13e0f7f795c725decd7 = UNSTREAM_STRING( &constant_bin[ 4751 ], 25, 0 );
    ...
    const_str_plain_info_dict = UNSTREAM_STRING( &constant_bin[ 4776 ], 9, 1 );
    ...
    const_str_plain_blas_opt_info = UNSTREAM_STRING( &constant_bin[ 4785 ], 13, 1 );
    ...
    const_str_plain_PATH = UNSTREAM_STRING( &constant_bin[ 4798 ], 4, 1 );
    ...
    const_str_plain_platform = UNSTREAM_STRING( &constant_bin[ 4802 ], 8, 1 );
    const_str_plain_win32 = UNSTREAM_STRING( &constant_bin[ 4810 ], 5, 1 );
    const_str_digest_a3476b294c24cd9f5df3c24553ac862a = UNSTREAM_STRING( &constant_bin[ 4815 ], 9, 0 );
    ...
    const_str_digest_835298b015ebc0bfaf66fb8f3bd30237 = UNSTREAM_STRING( &constant_bin[ 4824 ], 19, 0 );
