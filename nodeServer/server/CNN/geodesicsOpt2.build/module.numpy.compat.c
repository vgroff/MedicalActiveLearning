...
{
    const_str_digest_2a81da0a64105c559358acdbea78448b = UNSTREAM_STRING( &constant_bin[ 204944 ], 21, 0 );
    const_tuple_str_plain__inspect_tuple = PyTuple_New( 1 );
    const_str_plain__inspect = UNSTREAM_STRING( &constant_bin[ 204965 ], 8, 1 );
    PyTuple_SET_ITEM( const_tuple_str_plain__inspect_tuple, 0, const_str_plain__inspect ); Py_INCREF( const_str_plain__inspect );
    const_str_digest_f3a363a7f470012503419a2cae06c1e2 = UNSTREAM_STRING( &constant_bin[ 204973 ], 24, 0 );
    const_str_plain_NUITKA_PACKAGE_numpy_compat = UNSTREAM_STRING( &constant_bin[ 204997 ], 27, 1 );
    const_tuple_str_plain_py3k_tuple = PyTuple_New( 1 );
    const_str_plain_py3k = UNSTREAM_STRING( &constant_bin[ 205024 ], 4, 1 );
    ...
    const_str_digest_debbfb7d4cffd6e0773fb66f440d0d39 = UNSTREAM_STRING( &constant_bin[ 205028 ], 239, 0 );
