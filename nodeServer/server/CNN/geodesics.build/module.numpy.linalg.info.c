...
{
    const_str_digest_89e693285590e79430d162136a6b4413 = UNSTREAM_STRING( &constant_bin[ 1028815 ], 1104, 0 );
    const_str_digest_e6d29878148982bb383c2ffd63386eb7 = UNSTREAM_STRING( &constant_bin[ 1029919 ], 20, 0 );
    const_str_digest_02415e64e2eb2af89d58930190432cd8 = UNSTREAM_STRING( &constant_bin[ 1029939 ], 17, 0 );
    const_str_digest_fc62ac7c06e1cf627e844d703ca23411 = UNSTREAM_STRING( &constant_bin[ 1029956 ], 26, 0 );
...
static PyCodeObject *codeobj_bc0109acdcc5efdeecb24216747f9c55;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_e6d29878148982bb383c2ffd63386eb7 );
    codeobj_bc0109acdcc5efdeecb24216747f9c55 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_fc62ac7c06e1cf627e844d703ca23411, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_bc0109acdcc5efdeecb24216747f9c55;
    ...
    // Frame without reuse.
    frame_bc0109acdcc5efdeecb24216747f9c55 = MAKE_MODULE_FRAME( codeobj_bc0109acdcc5efdeecb24216747f9c55, module_numpy$linalg$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_bc0109acdcc5efdeecb24216747f9c55 );
    assert( Py_REFCNT( frame_bc0109acdcc5efdeecb24216747f9c55 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_bc0109acdcc5efdeecb24216747f9c55 );
#endif
    popFrameStack();

    assertFrameObject( frame_bc0109acdcc5efdeecb24216747f9c55 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_bc0109acdcc5efdeecb24216747f9c55, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_bc0109acdcc5efdeecb24216747f9c55->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_bc0109acdcc5efdeecb24216747f9c55, exception_lineno );
    }
