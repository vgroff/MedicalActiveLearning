...
{
    const_str_digest_08fe9a9d882984ccf2976175dccfa13c = UNSTREAM_STRING( &constant_bin[ 543689 ], 18, 0 );
    const_str_digest_cd33481e97a224ce41fd4aa567765029 = UNSTREAM_STRING( &constant_bin[ 543707 ], 21, 0 );
    const_str_plain_NUITKA_PACKAGE_numpy_fft = UNSTREAM_STRING( &constant_bin[ 543728 ], 24, 1 );
...
static PyCodeObject *codeobj_0afc6cfbd1dce8eedda5a9eeaa80b1e6;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_cd33481e97a224ce41fd4aa567765029 );
    codeobj_0afc6cfbd1dce8eedda5a9eeaa80b1e6 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_08fe9a9d882984ccf2976175dccfa13c, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6;
    ...
    // Frame without reuse.
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6 = MAKE_MODULE_FRAME( codeobj_0afc6cfbd1dce8eedda5a9eeaa80b1e6, module_numpy$fft );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6 );
    assert( Py_REFCNT( frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6 ) == 2 );

    // Framed code:
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 1;
    {
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 4;
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 6;
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 7;
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 9;
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 10;
    ...
    tmp_called_name_4 = GET_STRING_DICT_VALUE( moduledict_numpy$fft, (Nuitka_StringObject *)const_str_plain__numpy_tester );
    ...
    frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame.f_lineno = 11;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6 );
#endif
    popFrameStack();

    assertFrameObject( frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_0afc6cfbd1dce8eedda5a9eeaa80b1e6, exception_lineno );
    }
