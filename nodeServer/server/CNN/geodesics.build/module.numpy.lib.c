...
static void createModuleConstants( void )
{
    ...
    const_str_plain_tracemalloc_domain = UNSTREAM_STRING( &constant_bin[ 597339 ], 18, 1 );
    ...
    const_str_plain_arraypad = UNSTREAM_STRING( &constant_bin[ 597357 ], 8, 1 );
    const_str_plain_NUITKA_PACKAGE_numpy_lib = UNSTREAM_STRING( &constant_bin[ 597365 ], 24, 1 );
    const_str_plain_arraysetops = UNSTREAM_STRING( &constant_bin[ 597389 ], 11, 1 );
    const_str_plain_mixins = UNSTREAM_STRING( &constant_bin[ 597400 ], 6, 1 );
    const_str_plain__version = UNSTREAM_STRING( &constant_bin[ 3385 ], 8, 1 );
    const_tuple_str_plain_scimath_tuple = PyTuple_New( 1 );
    const_str_plain_scimath = UNSTREAM_STRING( &constant_bin[ 597406 ], 7, 1 );
    PyTuple_SET_ITEM( const_tuple_str_plain_scimath_tuple, 0, const_str_plain_scimath ); Py_INCREF( const_str_plain_scimath );
    const_str_plain_twodim_base = UNSTREAM_STRING( &constant_bin[ 597413 ], 11, 1 );
    const_str_digest_a8583e29b1c0eedaa1f165e55f2b3ed0 = UNSTREAM_STRING( &constant_bin[ 597424 ], 18, 0 );
    const_str_plain_arrayterator = UNSTREAM_STRING( &constant_bin[ 597442 ], 12, 1 );
    const_str_plain_financial = UNSTREAM_STRING( &constant_bin[ 597454 ], 9, 1 );
    const_str_digest_8f92f83ee2fc03c9c5f27a58e34fd246 = UNSTREAM_STRING( &constant_bin[ 597463 ], 21, 0 );
    ...
    const_str_plain_index_tricks = UNSTREAM_STRING( &constant_bin[ 16852 ], 12, 1 );
    const_str_plain_type_check = UNSTREAM_STRING( &constant_bin[ 597484 ], 10, 1 );
    const_str_plain_nanfunctions = UNSTREAM_STRING( &constant_bin[ 597494 ], 12, 1 );
    const_list_str_plain_emath_str_plain_math_str_plain_tracemalloc_domain_list = PyList_New( 3 );
    const_str_plain_emath = UNSTREAM_STRING( &constant_bin[ 597506 ], 5, 1 );
    ...
    const_str_plain_npyio = UNSTREAM_STRING( &constant_bin[ 597511 ], 5, 1 );
